...
class MazeFrame extends JFrame {                                            //Class which adds functionality & creates UI
	...
	public MazeFrame(int rowNumber, int colNumber) {
		...
		panel_1.setLayout(new BorderLayout(0, 0));
                ...
                //To design Welcome & About Screen
		panel_3 = new JPanel();
		panel_3.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, Color.DARK_GRAY));    //To display shadow 
		panel_1.add(panel_3);
		panel_3.setLayout(new BorderLayout(0, 0));

		label = new JLabel("Welcome to Maze\r\n");
		label.setFont(new Font("Lucida Handwriting", Font.PLAIN, 16));
		panel_3.add(label, BorderLayout.NORTH);

                //For Go & Quit buttons window
		panel_4 = new JPanel();
		...
		button_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				button_1.setEnabled(true);      //Pause
		...
		spinner.setModel(new SpinnerNumberModel(11, 11, 99, 2));
                //spinner.setModel(new SpinnerNumberModel(20, 11, 99, 1));
		...
		lblPleaseSelectThe_1 = new JLabel("Method to create Maze: ");
	...
	public static void main(String[] args) {
		try {
			...
			Toolkit tool = mazeFrame.getToolkit(); 
